...
public class MinioUtils {
    ...
    public static void download(String bucketName, String fileName, HttpServletResponse res) {
        download(bucketName, fileName, fileName, res);
    }

    public static void download(String bucketName, String fileName, String originalFileName, HttpServletResponse res) {
